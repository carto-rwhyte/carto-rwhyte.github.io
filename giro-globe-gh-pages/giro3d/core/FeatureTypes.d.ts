...
import type { Circle, Geometry, LinearRing, LineString, MultiLineString, MultiPoint, MultiPolygon, Point, Polygon, SimpleGeometry } from 'ol/geom';
import type { LineMaterial } from 'three/examples/jsm/lines/LineMaterial.js';
import { type ColorRepresentation, type Material, type Side, type SpriteMaterial, type Texture } from 'three';
export type GeometryFn<T, O> = (geom: T) => O;
export declare function mapGeometry<O>(geom: SimpleGeometry, callbacks: {
