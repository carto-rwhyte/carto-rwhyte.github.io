 ...
 *
 */
export declare class MaskLayer<UserData extends LayerUserData = LayerUserData> extends ColorLayer<UserData> {
    private _maskMode;
    /**
...
export declare function isMaskLayer(obj: unknown): obj is MaskLayer;
